...
$carsCarroussel = $pdo->query("SELECT * FROM cars WHERE id_car = '$_GET[id_car]'");
...
?>
        ...
        <div class='container'>
            <div class='row text-center intro-title'>
                <div class='col-md-6 text-md-left d-inline-block'>
                    <h1 class='text-white'><?php echo $detailsCars['car_brand'] ?></h1></div>
    ...
    <section class='car-details page-section-ptb'>
        <div class='container'>
            <div class='row'>
                <div class='col-md-9'>
                    <h3><?php echo $detailsCars['selling_price'] ?></h3></div>
                <div class='col-md-3'>
                    <div class='car-price text-lg-right'><strong><?php echo $detailsCars['car_brand'] ?></strong><span>TTC</span></div>
                    <img class="img-fluid" src="<?php echo $detailsCars["imgs"];?>" alt="#">
                </div>
            </div>
            <div class='row'>
                <div class='col-md-12'>
                ...
                <div class='col-md-8'>
                    ...
                    <div id='tabs'>
                        ...
                        <div id='tab1' class='tabcontent'>
                            <h6><?php echo $detailsCars['global_information'];?></h6>
                            <p>
                ...
                <div class='col-md-4'>
                    <div class='car-details-sidebar'>
                        <div class='details-block details-weight'>
                            <h5>DESCRIPTION</h5>
                            <ul>
                                <li> <span>Marque</span> <strong class='text-right'><?php echo $detailsCars['car_brand'];?></strong></li>
                                <li> <span>Modèle</span> <strong class='text-right'><?php echo $detailsCars['car_model'];?></strong></li>
                                <li> <span>Boite</span> <strong class='text-right'><?php echo $detailsCars['gearbox'];?></strong></li>
                                <li> <span>Moteur</span> <strong class='text-right'><?php echo $detailsCars['motor'];?></strong></li>
                                <li> <span>Chevaux fiscaux</span> <strong class='text-right'><?php echo $detailsCars['car_cv'];?></strong></li>
                                <li> <span>1ère immatriculation </span> <strong class='text-right'><?php echo $detailsCars['car_first_registration'];?></strong></li>
                                <li> <span>Kilométrage</span> <strong class='text-right'><?php echo $detailsCars['km'];?></strong></li>
                                <li> <span>Carburant</span> <strong class='text-right'><?php echo $detailsCars['car_type'];?></strong></li>
                                <li> <span>Couleur extérieure</span> <strong class='text-right'><?php echo $detailsCars['ext_color'];?></strong></li>
                                <li> <span>Couleur intérieure</span> <strong class='text-right'><?php echo $detailsCars['in_color'];?></strong></li>
                            </ul>
                        </div>
