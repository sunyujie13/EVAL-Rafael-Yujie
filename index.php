...
WHERE purchase_date >= (SELECT DATE_ADD(NOW(), INTERVAL -2 MONTH))");
?>
...
<!--=================================
 feature-car -->
      ...
      <!-- ALLEsR RECHERCHER EN BASE LES VOITURES RENTRÉES CES 2 DERNIERS MOIS ET DISPONIBLE (AVAILABILITY) -->
...
<?php
$carsCarroussel = $pdo->query("SELECT * FROM cars");
 while($detailsCars = $carsCarroussel->fetch(PDO::FETCH_ASSOC)) { ?>
    <div class='item'>
        <div class='car-item text-center'>
            ...
            <div class='car-list'>
                <ul class='list-inline'>
                    <li><i class='fa fa-registered'></i>
                        <?php echo $detailsCars["year"];?>
                    </li>
                    <li><i class='fa fa-cog'></i>
                        <?php echo $detailsCars["gearbox"];?>
                    </li>
                    <li><i class='fa fa-dashboard'></i>
                        <?php echo $detailsCars["km"];?>
                    </li>
                </ul>
            </div>
            <div class='car-content'>
                ...
                <a href="discriptionCars.php?id_car=<?php echo $detailsCars['id_car'];?>"><?php echo $detailsCars["car_brand"];?> </a>

                <div class='separator'></div>
                <div class='price'><span class='old-price'><?php echo $detailsCars["old_selling_price"];?>€</span><span class='new-price'><?php echo $detailsCars["selling_price"];?>€</span></div>
            </div>
        </div>
    </div>
    <?php } ?>
